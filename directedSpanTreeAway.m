...
%    vertex. The spanning trees are away from the root. If there are no     %
%    directed spanning trees from the indicated root vertex, only the given %
%    digraph will be shown. Furthermore, there is no output variable. The   %
%    function automatically generates the spanning tree.                    %
%                                                                           %
% INPUTS:                                                                   %
...
function directedSpanTreeAway(G, r)
