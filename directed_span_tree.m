...
%                                                                             %
%                                                                             %
% OUTPUT: Returns the reactions of the given directed graph and the reactions %
%            of the directed spanning trees rooted at the indicated vertex.   %
%            If there are no directed spanning trees from the indicated       %
%            root vertex, only the given digraph will be shown.               %
%         There is no output variable. The function automatically generates   %
%            the spanning tree.                                               %
%                                                                             %
% INPUTS:                                                                     %
...
function directed_span_tree(G, r)
